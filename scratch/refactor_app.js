...
const data = JSON.stringify({
  ...
  messages: [
    { role: 'system', content: 'You are a senior React developer. Refactor the provided code to be more modular. Extract large components into separate functions or files. Ensure all hooks and state are correctly handled. Provide the FULL refactored code for App.js.' },
